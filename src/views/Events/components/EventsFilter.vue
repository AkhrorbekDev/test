    ...
    <div class="filters">
        ...
        <div class="filters__content">
            ...
            <div class="filters__section filters__section--system">
                <div class="filters__section-title" @click="toggleSection('system')">Система <i
                        class="far fa-chevron-down"></i></div>
                <div class="filters__options" v-if="openSections.system">
                    <div class="filters__option">
                        <div class="filters__checkbox">
                            <input type="checkbox" name="" id="">
                        </div>
            ...
            <div class="filters__section filters__section--setting">
                <div class="filters__section-title" @click="toggleSection('setting')">Сеттинг <i
                        class="far fa-chevron-down"></i></div>
            </div>
            <div class="filters__section filters__section--duration">
                <div class="filters__section-title" @click="toggleSection('duration')">Длительность <i
                        class="far fa-chevron-down"></i></div>
            </div>
            <div class="filters__section filters__section--experience">
                <div class="filters__section-title" @click="toggleSection('experience')">Опыт игроков <i
                        class="far fa-chevron-down"></i></div>
            </div>
            <div class="filters__section filters__section--preparation">
                <div class="filters__section-title" @click="toggleSection('podgatovka')">Подготовка к игре <i
                        class="far fa-chevron-down"></i></div>
            </div>
            <div class="filters__section filters__section--character-level">
                <div class="filters__section-title" @click="toggleSection('personaj')">Ур. персонажа <i
                        class="far fa-chevron-down"></i></div>
            </div>
            <div class="filters__section filters__section--genre">
                <div class="filters__section-title" @click="toggleSection('genre')">Жанр <i
                        class="far fa-chevron-down"></i></div>
            </div>
        </div>
